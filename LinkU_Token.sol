...
contract LINKU is ERC20, ERC20Burnable, Ownable {
    uint256 constant private INITIAL_SUPPLY = 2_000_000_000 * 10**18;

    constructor() ERC20("LINKU", "LINKU") Ownable(msg.sender) {
